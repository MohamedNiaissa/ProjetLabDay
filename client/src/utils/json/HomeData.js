export const homeData = {
    intro: {
        title: "NextStep",
        text: "Nous vous donnons l'occasion de donnée une seconde vie à vos objets que vous n'utilisez plus. Selon votre besoin spécifique, l'objet en question est redirigé vers l'endroit le plus approprié. ",
    },
    desc: {
    ...
    sell: {
        title: "Vendre",
        link: "/vendre",
        img: "IllustrationSell.svg",
        text: "Entrez en contact facilement avec les acheteurs potentiels de votre région, et vendez votre objet en quelques clics.",
    },
    give: {
        title: "Donner",
        link: "/donner",
        img: "IllustrationGive.svg",
        text: "Découvrez les associations et particuliers qui reprendront vos objets et leur redonneront vie.",
    },
    discard: {
        title: "Jeter",
        link: "/jeter",
        img: "IllustrationDiscard.svg",
