...
import SBuild from "../partials/form/SellLayout";
                ...
                <main className="forms" id="main-content">
                    <div className="forms-box">
                        <div className="picture-wrapper">
                            <img className="picture" src={this.imagesStatic["sell.jpg"]} alt="pic"/>
                        </div>
                        ...
                        <div className="form-wrapper">
                            <form className="form">
                                ...
                                <div className="form-btn">
                                    <Redirect link={"/vendre/resultats"} product={this.product} city={this.city} disabled={!this.state.verify.form}/>
                                </div>
                            </form>
                        </div>
                    </div>
